...
describe('SearchBar Component', () => {
  it('should render a search input', () => {
    render(<SearchBar classList="SearchBar" onChangeFunc={() => {}} onKeyUpFunc={() => {}} />);
  ...
  it('should call onChangeFunc when input value changes', () => {
    ...
    render(<SearchBar classList="SearchBar" onChangeFunc={onChangeFunc} onKeyUpFunc={() => {}} />);
  ...
  it('should call onKeyUpFunc when a key is released', () => {
    ...
    render(<SearchBar classList="SearchBar" onChangeFunc={() => {}} onKeyUpFunc={onKeyUpFunc} />);
